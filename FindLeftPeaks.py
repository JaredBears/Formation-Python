...
print(findLeftPeaks([1,2,3,4,5,6]) == [6])
print(findLeftPeaks([6,5,4,3,2,1]) == [6,5,4,3,2,1])
print(findLeftPeaks([1,2,3,4,5,6,5,4,3,2,1]) == [6,5,4,3,2,1])
print(findLeftPeaks([]) == [])
print(findLeftPeaks([-1,-2,-3,-4,-5,-6]) == [-1,-2,-3,-4,-5,-6])